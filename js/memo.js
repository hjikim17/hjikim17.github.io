...
//       opacity: 0.1
//     };
//     newMemo.intersectInfo = intersectInfo;
//   }
...
//     // IFC 정보 추가
//     if (memos[i].intersectInfo) {
//       const intersectInfo = memos[i].intersectInfo;
//       const pickColorMatTransparent = new THREE.MeshLambertMaterial({
//         transparent: true,
//         opacity: intersectInfo.opacity,
//         color: intersectInfo.color,
//       });
      
//       ifcLoader.ifcManager.createSubset({
//         modelID: intersectInfo.modelID,
//         ids: intersectInfo.ids,
